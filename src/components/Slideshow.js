...
class Slideshow extends React.Component {
  ...
  LaunchShow(context) {
    imagesLoaded('.image-container', function() {
      ...
      context.state.controller = <SlideshowController currIndex={context.state.currIndex} nextIndex={context.state.nextIndex} spriteImagesSrc={spriteImagesSrc} rate={context.props.rate}/>
  ...
  render() {
    ...
    return (
      <SlideshowWrapper className="image-container">  
        <div>
          {images.map((img, i) => {
        ...
        {images[bgIndex] &&
          <Img sizes={images[bgIndex].sizes} alt="placeholder"/>
        }
